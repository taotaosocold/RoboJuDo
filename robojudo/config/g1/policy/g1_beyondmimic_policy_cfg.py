...
class G1BeyondMimic23DoF(DoFConfig):
    joint_names: list[str] = [
        "left_hip_pitch_joint",
        "right_hip_pitch_joint",
        "waist_yaw_joint",
    ...
    default_pos: list[float] | None = [
        -0.312, -0.312, 0.0, 0.0, 0.0, 0.2, 0.2, 0.0, 0.0, 0.2, -0.2, 0.669, 0.669, 0.0, 0.0, -0.363, -0.363, 0.6, 0.6, 0.0, 0.0, 0.0, 0.0
    ]

    stiffness: list[float] | None = [
        40.179, 40.179, 40.179, 99.098, 99.098, 14.251, 14.251, 40.179, 40.179, 14.251, 14.251, 99.098, 99.098, 14.251, 14.251, 28.501, 28.501, 14.251, 14.251, 28.501, 28.501, 14.251, 14.251
    ]

    damping: list[float] | None = [
        2.558, 2.558, 2.558, 6.309, 6.309, 0.907, 0.907, 2.558, 2.558, 0.907, 0.907, 6.309, 6.309, 0.907, 0.907, 1.814, 1.814, 0.907, 0.907, 1.814, 1.814, 0.907, 0.907
    ]


class G1BeyondMimicPolicyCfg23DOF(BeyondMimicPolicyCfg):
    robot: str = "g1"
    # policy_name: str = "Jump_wose"
    policy_name: str = "Dance_wose"
    # policy_name: str = "Violin"
    ...
    obs_dof: DoFConfig = G1BeyondMimic23DoF()
    action_dof: DoFConfig = obs_dof
    ...
    action_scales: list[float] = [
        0.548, 0.548, 0.548, 0.351, 0.351, 0.439, 0.439, 0.548, 0.548, 0.439, 0.439, 0.351, 0.351, 0.439, 0.439, 0.307, 0.307, 0.439, 0.439, 0.307, 0.307, 0.439, 0.439
    ]